...
// Logger_Close_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'Close'
type Logger_Close_Call struct {
	*mock.Call
}

// Close is a helper method to define mock.On call
func (_e *Logger_Expecter) Close() *Logger_Close_Call {
	return &Logger_Close_Call{Call: _e.mock.On("Close")}
}

func (_c *Logger_Close_Call) Run(run func()) *Logger_Close_Call {
...
func (_c *Logger_Close_Call) Return(_a0 error) *Logger_Close_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *Logger_Close_Call) RunAndReturn(run func() error) *Logger_Close_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_e *Logger_Expecter) Debug(msg interface{}, keysAndValues ...interface{}) *Logger_Debug_Call {
	return &Logger_Debug_Call{Call: _e.mock.On("Debug",
		append([]interface{}{msg}, keysAndValues...)...)}
}

func (_c *Logger_Debug_Call) Run(run func(msg string, keysAndValues ...interface{})) *Logger_Debug_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
// Error provides a mock function with given fields: msg, keysAndValues
func (_m *Logger) Error(msg string, keysAndValues ...interface{}) {
	var _ca []interface{}
	_ca = append(_ca, msg)
	_ca = append(_ca, keysAndValues...)
	_m.Called(_ca...)
...
//   - msg string
//   - keysAndValues ...interface{}
func (_e *Logger_Expecter) Error(msg interface{}, keysAndValues ...interface{}) *Logger_Error_Call {
	return &Logger_Error_Call{Call: _e.mock.On("Error",
		append([]interface{}{msg}, keysAndValues...)...)}
}

func (_c *Logger_Error_Call) Run(run func(msg string, keysAndValues ...interface{})) *Logger_Error_Call {
	_c.Call.Run(func(args mock.Arguments) {
		variadicArgs := make([]interface{}, len(args)-1)
		for i, a := range args[1:] {
			if a != nil {
...
//   - msg string
//   - keysAndValues ...interface{}
func (_e *Logger_Expecter) Info(msg interface{}, keysAndValues ...interface{}) *Logger_Info_Call {
	return &Logger_Info_Call{Call: _e.mock.On("Info",
		append([]interface{}{msg}, keysAndValues...)...)}
}

func (_c *Logger_Info_Call) Run(run func(msg string, keysAndValues ...interface{})) *Logger_Info_Call {
	_c.Call.Run(func(args mock.Arguments) {
		variadicArgs := make([]interface{}, len(args)-1)
		for i, a := range args[1:] {
			if a != nil {
...
func (_m *Logger) Warn(msg string, keysAndValues ...interface{}) {
	var _ca []interface{}
	_ca = append(_ca, msg)
	_ca = append(_ca, keysAndValues...)
	_m.Called(_ca...)
...
//   - msg string
//   - keysAndValues ...interface{}
func (_e *Logger_Expecter) Warn(msg interface{}, keysAndValues ...interface{}) *Logger_Warn_Call {
	return &Logger_Warn_Call{Call: _e.mock.On("Warn",
		append([]interface{}{msg}, keysAndValues...)...)}
}

func (_c *Logger_Warn_Call) Run(run func(msg string, keysAndValues ...interface{})) *Logger_Warn_Call {
	_c.Call.Run(func(args mock.Arguments) {
		variadicArgs := make([]interface{}, len(args)-1)
		for i, a := range args[1:] {
			if a != nil {
